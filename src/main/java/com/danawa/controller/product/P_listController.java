...
public class P_listController {
	...
	/* SSD */
	@RequestMapping("/ssdSearch")
	public String ssdSearch(Model model) {
		...
		return "/p_list/ssdSearch";
	}

	@RequestMapping("/ssdList")
	public ModelAndView ssdList(@RequestParam int volume) {

		List<DiskDTO> list = p_diskDAO.getSsdList(volume);
		ModelAndView mv = new ModelAndView();
		mv.addObject("list", list);
		mv.setViewName("/p_list/ssdList");
		return mv;
	}

	/* SSD */
	/* HDD */
	@RequestMapping("/hddSearch")
	public String hddSearch(Model model) {
		List<Integer> list = new ArrayList<>();
		...
		model.addAttribute("list", list);
		return "/p_list/hddSearch";
	}

	@RequestMapping("/hddList")
	public ModelAndView hddList(@RequestParam int volume) {

		List<DiskDTO> list = p_diskDAO.getHddList(volume);
		ModelAndView mv = new ModelAndView();
		mv.addObject("list", list);
		mv.setViewName("/p_list/hddList");
		return mv;
	}
	/* HDD */
