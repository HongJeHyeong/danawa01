...
<body>
    ...
    <form class="w3-container w3-card-4" name="qwFrm" id="qwFrm" action="./writeProc" method="post">
        <h2>Q&A 작성</h2>

        <p><label>작성자</label>
            <input class="w3-input w3-border" name="writer" id="writer" type="text" value="${sessionScope.member_id}" readonly>
            <input type="hidden" name="fk_member_no" id="fk_member_no" value="${sessionScope.member_no}"> 
            </p>
        ...
        <p><label>내용</label>
            <textarea class="w3-input w3-border" rows="5" id="qna_content" name="qna_content" style="resize: none;"></textarea>
        </p>
