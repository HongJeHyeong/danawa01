...
<body>
	...
	<div class="sw-center">
		...
		<form action="../notice/updateProc" method="post">
			...
			<hr/>
			<label>시행일</label>
			<input class="w3-input w3-border" name="notice_regdate" value="${list.notice_regdate}">~<input class="w3-input w3-border" name="notice_enddate" value="${list.notice_enddate}"> 
			<hr/>
			<label>내용</label>
