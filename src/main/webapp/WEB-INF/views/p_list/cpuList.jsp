		...
		<div class="w3-card w3-padding-4 item">
			<div class="w3-row">
				...
				<div class="w3-rest">
					...
					<div class="">
						<span class="w3-left">
							<fmt:formatNumber value="${dto.cpu_price}" type="currency" /></span> <span class="w3-right">
				...
				<div class="w3-col w3-red itemContent" style="white-space: normal;">
					<div class="w3-col w3-red itemContent" style="white-space: normal;">
						<c:if test="${dto.cpu_company eq 'AMD'}">
							<span class="w3-tag w3-green">${dto.cpu_company}</span>
						</c:if>
						<c:if test="${dto.cpu_company eq 'Intel'}">
							<span class="w3-tag w3-blue">${dto.cpu_company}</span>
						</c:if>
